...
func helloWorld() (string, error) { //(uri, username, password string) (string, error) {
	var (
		driver  neo4j.Driver
	...
	if driver, err = neo4j.NewDriver("bolt://localhost:7687", neo4j.BasicAuth("neo4j", "123456", "")); err != nil {
